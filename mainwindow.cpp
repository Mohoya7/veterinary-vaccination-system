...
// Custom central widget with dot texture background
    ...
    , m_role(role)
{
    ...
    // Replace central widget with textured one
    ...
    // Render SVG and tint it to white for dark sidebar
    ...
    this->setStyleSheet(R"(
        ...
        QPushButton#btnToggleSidebar:pressed {
            background-color: rgba(255,255,255,0.05);
        }

        /* Sidebar base */
        QFrame#sidebarDivider, QFrame#logoutDivider {
        ...
        /* Logout button */
        QWidget#sidebarWidget #btnLogout {
        ...
        QScrollArea QScrollBar::handle:vertical {
            background: rgba(100, 170, 80, 150);
            border-radius: 3px;
            min-height: 30px;
        }
        QScrollArea QScrollBar::handle:vertical:hover {
            background: rgba(100, 170, 80, 220);
        }
    ...
    // Sidebar slide animation on maximumWidth
...
{
    // Draw hamburger icon manually (3 lines)
